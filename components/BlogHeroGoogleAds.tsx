...
export default function BlogHeroGoogleAds() {
  return (
      ...
      <div className="relative mx-auto max-w-4xl px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <p
            ...
            style={{ fontFamily: '"Open Runde", "Open Runde Placeholder", sans-serif' }}
          >
            As a local business owner, you want more customers walking through your door. Google Ads can make that happen by putting your business in front of people searching for your services nearby. With 46% of Google searches having local intent, the right ad strategy can double your leads and drive foot traffic.
          </p>
