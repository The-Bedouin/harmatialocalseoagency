...
export default function BlogHeroGoogleBusinessProfile() {
  return (
    <motion.section
    ...
    >
      ...
      <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8 py-16 text-center">
        ...
        >
          Learn how to optimize your Google Business Profile for local searches with our comprehensive guide. Boost your local SEO rankings with photos, reviews, and more expert tips.
        </motion.p>
      </div>
    </motion.section>
  );
