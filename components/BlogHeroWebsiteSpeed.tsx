...
export default function BlogHeroWebsiteSpeed() {
  return (
    <motion.section
    ...
    >
      ...
      <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8 py-16 text-center">
        ...
        >
          Learn how to speed up your website for better local SEO rankings. Simple steps like image compression can boost conversions by 7% and improve local search visibility.
        </motion.p>
      </div>
    </motion.section>
  );
