...
export default function BlogTOCSidebarLocalSEO() {
  const [activeSection, setActiveSection] = useState("introduction");
  const [scrollProgress, setScrollProgress] = useState(0);

  const tocItems = useMemo(() => [
    { id: "introduction", title: "Introduction", level: 1 },
    { id: "why-local-seo-matters", title: "Why Local SEO Matters", level: 2 },
    { id: "step-1-google-business-profile", title: "Step 1: Optimize Google Business Profile", level: 2 },
    { id: "step-2-local-citations", title: "Step 2: Build Local Citations", level: 2 },
    { id: "step-3-local-content", title: "Step 3: Create Local Content", level: 2 },
