...
export default function BlogTOCSidebarWebsiteSpeed() {
  ...
  const tocItems = useMemo(() => [
    ...
    { id: "step-2-compress-images", title: "Step 2: Compress Images Without Losing Quality", level: 2 },
    { id: "step-3-enable-caching", title: "Step 3: Enable Browser Caching", level: 2 },
